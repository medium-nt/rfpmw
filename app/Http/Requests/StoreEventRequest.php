...
/**
 * Валидация создания нового события в контексте контрагента.
 */
class StoreEventRequest extends FormRequest
{
    ...
    /**
     * Правила полей события. Привязка — единственная (формат type:id), должна принадлежать этому контрагенту.
     *
    ...
    public function rules(): array
    {
        return [
            ...
            'link' => ['nullable', $this->linkRule($this->route('contractor')->id)],
        ];
    }
